...
class UNetplusplus(nn.Module):
    ...
    def __init__(self, in_channels=4, n_classes=4, feature_scale=2, is_deconv=True, is_batchnorm=True, is_ds=True):
    ...
    def forward(self, inputs):
        ...
        # column : 0
        X_00 = self.conv00(padded_image)  # 16*512*512
...
# model = UNetplusplus()
# image = torch.rand(1,4,1024,1024)
